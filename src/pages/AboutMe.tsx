        ...
        <div className="flex flex-row justify-center items-center w-full min-h-screen">
            <div className="grid grid-col-1 lg:grid-cols-2 w-full">
                <div className="flex flex-col justify-center items-center lg:items-baseline mx-20">
                    <h1 className="text-7xl text-gray-600 pb-5 text-center lg:text-start">Hi, I am Sergio Aguilar,</h1>
                    <p className="text-2xl text-gray-600 pb-5 text-center lg:text-start">I am a Sr. Software Engineer with 4 years of experience, passionate about learning and always eager to face new challenges.</p>
